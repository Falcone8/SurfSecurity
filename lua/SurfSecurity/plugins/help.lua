...
local Util = require("SurfSecurity.util")
...
`$rules`: _will be replaced by a link to the rules of the group. Please read_ [here](https://telegram.me/SurfSecurity_beta/26) _how to use it, or you will get an error for sure_
...
*Note:* the markdown is supported. If the text sent breaks the markdown, the bot will notify that something is wrong.
For a correct use of the markdown, check [this post](https://telegram.me/SurfSecurity_ch/46) in the channel.
