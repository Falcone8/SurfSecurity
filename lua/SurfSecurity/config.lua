...
local _M =
{
	...
	postgres = {
		...
		database = os.getenv('POSTGRES_DB') or 'SurfSecurity',
	},
	redis =
	{
	...
	channel = os.getenv("GB_CHANNEL") or '@SurfSecurity_ch',
	source_code = os.getenv("GB_SOURCE") or 'https://github.com/group-butler/SurfSecurity',
